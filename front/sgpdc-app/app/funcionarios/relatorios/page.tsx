  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <Link href="/funcionarios/relatorios/turmas" className="rounded-[32px] border border-[#E5E7EB] bg-white p-6 text-left shadow-sm transition hover:border-[#6A4FBF] hover:bg-[#F9FAFB]">
        ...
        <Link href="/funcionarios/relatorios/presencas" className="rounded-[32px] border border-[#E5E7EB] bg-white p-6 text-left shadow-sm transition hover:border-[#6A4FBF] hover:bg-[#F9FAFB]">
          <p className="text-sm uppercase tracking-[0.22em] text-[#6A4FBF]">Relatório</p>
