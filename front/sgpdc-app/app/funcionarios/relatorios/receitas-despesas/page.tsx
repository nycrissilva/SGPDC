  ...
  return (
    <div className="space-y-8">
      <section className="rounded-[32px] bg-[#1F2A5A] p-6 text-white shadow-sm">
        ...
        <h1 className="mt-4 text-4xl font-semibold tracking-tight">Receitas e Despesas</h1>
        <p className="mt-4 max-w-2xl text-sm leading-6 text-[#F8FAFC]/90">
          Acompanhe entradas, saídas, saldo do período e movimentações financeiras em uma tela dedicada.
        </p>
      </section>
        ...
        <div className="space-y-4">
          <div className="h-[240px]">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie data={data} dataKey="value" nameKey="name" cx="50%" cy="50%" innerRadius={58} outerRadius={86} paddingAngle={2} labelLine={false}>
                  {data.map((item) => (
