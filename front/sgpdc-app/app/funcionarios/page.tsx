  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <Link href="/funcionarios/alunos" className="rounded-[32px] border border-[#E5E7EB] bg-white p-6 text-left shadow-sm transition hover:border-[#6A4FBF] hover:bg-[#F9FAFB]">
        ...
        <Link href="/funcionarios/responsaveis" className="rounded-[32px] border border-[#E5E7EB] bg-white p-6 text-left shadow-sm transition hover:border-[#6A4FBF] hover:bg-[#F9FAFB]">
          <p className="text-sm uppercase tracking-[0.22em] text-[#6A4FBF]">Gerenciar</p>
        ...
        <Link href="/funcionarios/professores" className="rounded-[32px] border border-[#E5E7EB] bg-white p-6 text-left shadow-sm transition hover:border-[#6A4FBF] hover:bg-[#F9FAFB]">
          <p className="text-sm uppercase tracking-[0.22em] text-[#6A4FBF]">Gerenciar</p>
        ...
        <Link href="/funcionarios/modalidades" className="rounded-[32px] border border-[#E5E7EB] bg-white p-6 text-left shadow-sm transition hover:border-[#6A4FBF] hover:bg-[#F9FAFB]">
          <p className="text-sm uppercase tracking-[0.22em] text-[#6A4FBF]">Gerenciar</p>
          <h2 className="mt-3 text-xl font-semibold text-[#1F2A5A]">Modalidades</h2>
          <p className="mt-2 text-sm text-[#4B5563]">Cadastre e edite as modalidades oferecidas.</p>
        </Link>

        <Link href="/funcionarios/locais" className="rounded-[32px] border border-[#E5E7EB] bg-white p-6 text-left shadow-sm transition hover:border-[#6A4FBF] hover:bg-[#F9FAFB]">
          <p className="text-sm uppercase tracking-[0.22em] text-[#6A4FBF]">Gerenciar</p>
          <h2 className="mt-3 text-xl font-semibold text-[#1F2A5A]">Locais</h2>
        ...
        <Link href="/funcionarios/turmas" className="rounded-[32px] border border-[#E5E7EB] bg-white p-6 text-left shadow-sm transition hover:border-[#6A4FBF] hover:bg-[#F9FAFB]">
          <p className="text-sm uppercase tracking-[0.22em] text-[#6A4FBF]">Gerenciar</p>
        ...
        <Link href="/funcionarios/relatorios" className="rounded-[32px] border border-[#E5E7EB] bg-white p-6 text-left shadow-sm transition hover:border-[#6A4FBF] hover:bg-[#F9FAFB]">
          ...
          <h2 className="mt-3 text-xl font-semibold text-[#1F2A5A]">Relatórios</h2>
          <p className="mt-2 text-sm text-[#4B5563]">Emita relatórios de turmas e de presença para apoio pedagógico e administrativo.</p>
        </Link>
      </div>
    </div>
  );
